        ...
        <View style={{ height: height / 3, justifyContent: 'center' }}>
          ...
          <Animated.View style={{ zIndex: this.textInputZindex,opacity:this.textInputOpacity,transform:[{translateY:this.textInputY}], height:height/3, ...StyleSheet.absoluteFill, top:null, justifyContent:'center'}}>
            ...
            <Item floatingLabel last>
                <Input placeholder="Email" onChangeText={(email)=>this.setState({email})} style={styles.textInput}/>
                
            </Item>
            <Item floatingLabel last>
           <Input   onChangeText={(password)=>this.setState({password})}secureTextEntry={true} underlineColorAndroid='tranparent' placeholder="Password" style={styles.textInput} />
           </Item>
